...
from .views import HausZuVerkaufenViewSet, LoginView, RegisterView, ListAdminsView, KontaktanfrageListCreateView, index  # Import correct
from django.views.generic import TemplateView  # Import correct
 # Import correct
